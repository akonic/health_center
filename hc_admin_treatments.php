    ...
    <div class="container" id="11" style="display: block;">
        <table class="table">
            ...
            <tbody>
              ...
              $selectquery = "SELECT * FROM `hc_registration`";
              ...
              while($res = mysqli_fetch_array($query)){
                ...
                <tr>
                    ...
                    <td><a href="uploads/<?php echo $res['file'] ?>" target="_blank">view file</a></td>
                    <td><a href="hc_admin_update_record.php?id=<?php echo $res['consult_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                    <td><a href="delete_record.php?id=<?php echo $res['consult_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
                <?php
              }
              ?>
