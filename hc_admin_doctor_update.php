...
<body>
 ...
 $ids=$_GET['id'];
 $showquery = "select * from hc_doctor where doctor_id={$ids}";
 ...
 {$idu=$_GET['id'];
   ...
   $insert = " update hc_doctor set doctor_name='$name',speciality='$spec' where doctor_id='$idu'";
...
window.location = 'http://localhost/health_center/hc_admin_doctor.php';
</script>
<?php
     }
...
?>
    <div class="container" id="44" style="display: block;">
        <form action="" method="POST">
            ...
            <input type="text" id="fname" name="id" value="<?php echo $arrdata['doctor_id']; ?>"><br>
            <label for="lname">Doctor Name :</label>
            <input type="text" id="pnaem" name="name" value="<?php echo $arrdata['doctor_name']; ?>"><br>
            <label for="lname">Speciality :</label>
            <input type="text" id="dname" name="spc" value="<?php echo $arrdata['speciality']; ?>"><br>
