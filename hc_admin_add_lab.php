...
<body>
    ...
    <div class="container-fluid mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="border:1px solid black;">
                <a href="http://localhost/health_center/hc_admin_doctors.php">
                    <div class="box">
...
<?php
 ...
 if(isset($_POST['submit']))
 {
   ...
   $insert = " insert into hc_labs(lab_name,cont_start_date,cont_end_date,tests)
    values ('$name','$sdate','$edate','$test')";
