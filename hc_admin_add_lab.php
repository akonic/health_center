...
<body>
    ...
    <div class="container" id="44" style="display: block;">
        <form action="" method="POST">
            ...
            <label for="fname">Lab Address :</label>
            <input type="text" id="fname" name="laddress"><br>
            <label for="lname">Start Date :</label>
            <input type="text" id="pnaem" name="sdate"><br>
            <label for="lname">End Date :</label>
            <input type="text" id="dname" name="edate"><br>
            <label for="lname">Tests:</label>
            <input type="text" id="dname" name="test"><br>
            <label for="lname">Price:</label>
            <input type="text" id="dname" name="price"><br>
...
<?php
 ...
 if(isset($_POST['submit']))
 {
   ...
   $insert = " insert into hc_labs(lab_name,cont_start_date,cont_end_date,tests,price,lab_address)
    values ('$name','$sdate','$edate','$test','$price','$laddress')";
