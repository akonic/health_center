...
<body>
   ...
   <div onclick="addDoctor()" style="border:1px solid black;" >Add Doctor Record</div>
    ...
    <div class="container" id="44" style="display: block;">
        <form action="hc_admin_home.php" method="POST">
            <label for="fname">Consultation ID :</label>
...
<script>
     ...
     function addDoctor()
    {  alert("SSS");
        var x = document.getElementById("33"),y = document.getElementById("11"),z=document.getElementById("44");
