...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white" style="box-shadow: 0px 5px 15px  rgb(166, 166, 166);">
        <div class="container-fluid"><a class="navbar-brand" href="http://localhost/mis/"><img src = "images/iitismlogo.png" style = "width: 50px; height: 50px;">   HealthISM</a></div>
    ...
    <div class="container" id="44" style="display: block;">
        <form action="" method="POST">
            ...
            <input type="text" id="pnaem" name="pname"><br>
            <label for="lname">Patient ID :</label>
            <input type="text" id="pnaem" name="pid"><br>
...
<?php
 ...
 if(isset($_POST['submit']))
 {
   ...
   $date=date("d-m-Y");
   $ids=$_POST['pid'];
   $insert = " insert into hc_registration(patient_name,patient_id,doctor_name,test_prescribed,date)
    values ('$name','$ids','$doctor','$test','$date')";
...
window.location = 'http://localhost/health_center/hc_admin_home.php';
</script>
<?php
     }
